...
//                base++;
//                if (value <= target) {
//                    List<Integer> list = map.computeIfAbsent(value, f -> new ArrayList<>());
...
//
//
//        for (int i1 = 1; i1 <= target / 2; i1++) {
//            int i2 = target - i1;
//            List<Integer> integers1 = map.get(i1);
//            List<Integer> integers2 = map.get(i2);
//            if (integers1 == null || integers2 == null) {
//                continue;
//            }
//            for (int value1 : integers1) {
//                int times1 = i1 / value1;
//                ArrayList<Integer> value1List = new ArrayList<>();
//                for (int i = 0; i < times1; i++) {
//                    value1List.add(value1);
//                }
//                for (int value2 : integers2) {
//                    int times2 = i2 / value2;
//                    ArrayList<Integer> valueList = new ArrayList<>();
//                    valueList.addAll(value1List);
